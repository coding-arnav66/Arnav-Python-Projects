...
def add(a, b):
    return a + b
print("The average is:", int((reduce(add, data.values())))/int(len(data.values())))
print("Percentage is:", (int(reduce(add, data.values()))/fm)*100)
...
print("Improvement is required in the subject(s) you got:", data[lowest_sub])
