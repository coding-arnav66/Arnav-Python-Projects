...
### This is a python programe named as automatic chat replier. It can reply flawlessly first knowing about the person by asking a question through input(Tell about the person: ), then copying the past messages, sending them to gemini(No API integration needed and is completely free) through pre decided prompt (modified every time) and pasting the reply given by gemini back in the whatsapp chatbox...
